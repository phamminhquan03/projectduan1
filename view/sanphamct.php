            ...
            if (isset($_SESSION['user'])) {
                echo '
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantity" name="soluong" class="form-control" value="1" min="1" style="width:100px;">
                    </div>
...
<div class="related-products">
    ...
    <div class="related-product">
        ...
        foreach ($sp_cung_loai as $sp_cung_loai) {
            ...
            $mr = (($i % 3 == 2) ? "" : "margin_right");

            echo '<div class="related-product-details">
                    <a href="' . $linksp . '"><img src="' . $img . '" ></a>
                    <center>
                        <div class="linksp"><li><a href ="' . $linksp . '">' . $name . '</a><li></div>
                        <div class="related-product-price">Giá: ' . $price . ' USD</div>
                    </center>
                </div>';
            $i++;
        }
