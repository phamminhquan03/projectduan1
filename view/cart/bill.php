<div class="row mb">
    <div class="boxtrai mr">
        <?php if (isset($_SESSION['mycart']) && count($_SESSION['mycart']) > 0): // Kiểm tra giỏ hàng ?>
            <form action="index.php?act=billcomfirm" method="post">
                <div class="row mb">
                    ...
                    <div class="row mb bill">
                        <center><input type="submit" value="ĐỒNG Ý ĐẶT HÀNG" name="dongydathang"></center>
                    </div>
                </div>
            </form>
        <?php else: // Nếu giỏ hàng rỗng ?>
            <div class="alert alert-warning text-center">
                <h1>Giỏ hàng của bạn hiện tại không có sản phẩm nào.</h1>
